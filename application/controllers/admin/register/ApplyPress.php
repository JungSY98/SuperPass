...
/**
 * 관리자>등록>ApplyPress controller 입니다.
 */
class ApplyPress extends CB_Controller
{
	 ...
	 * 페이지 이동시 필요한 정보입니다
	 */
	public $pagedir = 'register/applyPress';
	...
	public function form() {
		...
		$formD = $this->site->selectQuery("select * from gcs_applyform where pNo = '2' order by fieldOrder asc, no asc");
	...
	public function dnList() {
		...
		header('Content-Disposition: attachment;filename="'.$fileName.'_프레스_등록현황_'.date("Y-m-d_H:i").'.xls"');
