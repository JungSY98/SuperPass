...
class Verify extends CB_Controller
{
	...
	public function resetpassword()
	{
		...
		$password_description_en = 'Password must be at least ' . $password_length . ' characters long';
		if ($this->cbconfig->item('password_uppercase_length') OR $this->cbconfig->item('password_numbers_length') OR $this->cbconfig->item('password_specialchars_length')) {
			$password_description_en .= ' and must contain ';
			if ($this->cbconfig->item('password_uppercase_length')) {
				$password_description_en .= ', ' . $this->cbconfig->item('password_uppercase_length') . ' uppercase letter';
			}
			if ($this->cbconfig->item('password_numbers_length')) {
				$password_description_en .= ', ' . $this->cbconfig->item('password_numbers_length') . ' numbers';
			}
			if ($this->cbconfig->item('password_specialchars_length')) {
				$password_description_en .= ', ' . $this->cbconfig->item('password_specialchars_length') . ' special character';
			}
			$password_description_en .= '';
		}
		$password_description_en .= '.';

		$view['view']['info'] = element("langSet", $_SESSION) == 'english' ? $password_description_en : $password_description;
