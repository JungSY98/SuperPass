 ...
 */
class Mypage__ extends CB_Controller
{
	...
	public function index()
	{
		...
		$view['productD'] = array();
		if ($brandNo >0) {
			$brandD = $this->site->selectCI("*", "brand", array("no"=>$brandNo), "");
			$view['brandD'] = isset($brandD[0]) ? $brandD[0] : array();
			$view['productD'] = $this->site->selectCI("*", "product", array("brandNo"=>$brandNo), "");
		}
