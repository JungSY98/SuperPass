...
$config['uri_segment_post_type'] ='B';
 ...
 */
$config['encryption_key'] = 'SY_Entropy_!@#$%^&*()';
...
// 관리자 메모
$config['csrf_exclude_uris'][] = 'admin/main/ajaxGetMemo';
$config['csrf_exclude_uris'][] = 'admin/main/ajaxSaveMemo';

// 자동저장
$config['csrf_exclude_uris'][] = 'category/upload_icon';
$config['csrf_exclude_uris'][] = 'ajax/splash-seen';
 ...
 * 버전 체크용으로 사용됩니다
 */
$config['ciboard_website'] = 'http://www.donic.info/';
$config['ciboard_check_latest_version'] = 'http://www.donic.info/version/check/';


/* 로그인 Pass IP 설정 */
$config['login_pass_ip'] = array(
	'192.168.0.1', 
	'210.120.40.117',
	'210.120.40.53'
);

$config['arrayGender'] = array(
	1 => "Male",
	2 => "Female",
	3 => "Transgender",
	4 => "Nonbinary",
