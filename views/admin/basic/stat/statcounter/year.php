			...
			<form class="form-inline" name="flist" method="get" >
				<div class="box-table-button">
					...
					<div class="btn-group mt-4 mb-4" role="group" aria-label="...">
						...
						<button data-page-url="<?php echo admin_url($this->pagedir . '/year'); ?>" class="btn btn-warning btn-sm statsubmit">년</button>
					</div>
				</div>
			</form>
...
$(document).on('click', '#export_to_excel', function(){
	exporturl = '<?php echo admin_url($this->pagedir . '/year/excel' . '?' . $this->input->server('QUERY_STRING', null, '')); ?>';
