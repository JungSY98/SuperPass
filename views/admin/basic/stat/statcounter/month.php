			...
			<form class="form-inline" name="flist" method="get" >
				<div class="box-table-button">
					...
					<div class="btn-group mt-4 mb-4" role="group" aria-label="...">
						...
						<button data-page-url="<?php echo admin_url($this->pagedir . '/hour'); ?>" class="btn btn-secondary btn-sm statsubmit">시간</button>
						...
						<button data-page-url="<?php echo admin_url($this->pagedir . '/month'); ?>" class="btn btn-warning btn-sm statsubmit">월</button>
...
$(document).on('click', '#export_to_excel', function(){
	exporturl = '<?php echo admin_url($this->pagedir . '/month/excel' . '?' . $this->input->server('QUERY_STRING', null, '')); ?>';
