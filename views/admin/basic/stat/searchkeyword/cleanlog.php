	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-pills">
				<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">인기검색어</a></li>
				<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/rank'); ?>">순위</a></li>
				...
				<tbody>
					<tr>
						<td>
							...
							?>
								<input type="number" class="form-control" name="day" value="<?php echo set_value('day', 180); ?>" /> 일 이상된 검색어로그를 모두 검색합니다.
