<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/notification'); ?>" onclick="return check_form_changed();" class="nav-link active">알림기능</a></li>
