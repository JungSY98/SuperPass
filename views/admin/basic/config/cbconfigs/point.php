<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();" class="nav-link">기본정보</a></li>
			...
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/point'); ?>" onclick="return check_form_changed();" class="nav-link active">포인트기능</a></li>
