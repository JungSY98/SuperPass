<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();" class="nav-link active">기본정보</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/access'); ?>" onclick="return check_form_changed();" class="nav-link">접근기능</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/point'); ?>" onclick="return check_form_changed();" class="nav-link">포인트기능</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/general'); ?>" onclick="return check_form_changed();" class="nav-link">일반기능 / 에디터</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/note'); ?>" onclick="return check_form_changed();" class="nav-link">쪽지기능</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/notification'); ?>" onclick="return check_form_changed();" class="nav-link">알림기능</a></li>
			<li class="nav-item" role="presentation"><a href="<?php echo admin_url($this->pagedir . '/company'); ?>" onclick="return check_form_changed();" class="nav-link">회사정보</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
