<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/memberleave'); ?>" onclick="return check_form_changed();">회원탈퇴</a></li>
	...
	<div class="box-table">
		...
		?>
			...
			<div class="alert alert-success">
				<p>치환가능변수 : <strong>{홈페이지명}</strong>, <strong>{회사명}</strong>, <strong>{홈페이지주소}</strong>, <strong>{회원아이디}</strong>, <strong>{회원닉네임}</strong>, <strong>{회원실명}</strong>, <strong>{회원이메일}</strong>, <strong>{메일수신여부}</strong>, <strong>{쪽지수신여부}</strong>, <strong>{문자수신여부}</strong>, <strong>{회원아이피}</strong></p>
				<p><strong>{메일수신여부}</strong>, <strong>{쪽지수신여부}</strong>, <strong>{문자수신여부}</strong> 는 <strong>동의</strong>, <strong>거부</strong> - 이 2개 중 하나로 치환됩니다</p>
				<p><strong>{회원아이피}</strong> 는 회원탈퇴시 접속한 실제 IP 로 치환됩니다</p>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<div class="form-group col-sm-12">
						<input type="text" class="form-control" name="send_email_memberleave_admin_title" id="send_email_memberleave_admin_title" value="<?php echo set_value('send_email_memberleave_admin_title', element('send_email_memberleave_admin_title', element('data', $view))); ?>" />
					</div>
					<div class="form-group col-sm-12">
						<?php echo display_dhtml_editor('send_email_memberleave_admin_content', set_value('send_email_memberleave_admin_content', element('send_email_memberleave_admin_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<div class="form-group col-sm-12">
						<input type="text" class="form-control" name="send_email_memberleave_user_title" id="send_email_memberleave_user_title" value="<?php echo set_value('send_email_memberleave_user_title', element('send_email_memberleave_user_title', element('data', $view))); ?>" />
					</div>
					<div class="form-group col-sm-12">
						<?php echo display_dhtml_editor('send_email_memberleave_user_content', set_value('send_email_memberleave_user_content', element('send_email_memberleave_user_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<div class="form-group col-sm-12">
						<input type="text" class="form-control" name="send_note_memberleave_admin_title" id="send_note_memberleave_admin_title" value="<?php echo set_value('send_note_memberleave_admin_title', element('send_note_memberleave_admin_title', element('data', $view))); ?>" />
					</div>
					<div class="form-group col-sm-12">
						<?php echo display_dhtml_editor('send_note_memberleave_admin_content', set_value('send_note_memberleave_admin_content', element('send_note_memberleave_admin_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10 form-inline has-success ">
					<textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="send_sms_memberleave_admin_content" id="send_sms_memberleave_admin_content"><?php echo set_value('send_sms_memberleave_admin_content', element('send_sms_memberleave_admin_content', element('data', $view))); ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">
				...
				<div class="col-sm-10 form-inline has-success ">
					<textarea class="form-control" style="width:140px;background-color:#d9edf7" rows="5" name="send_sms_memberleave_user_content" id="send_sms_memberleave_user_content"><?php echo set_value('send_sms_memberleave_user_content', element('send_sms_memberleave_user_content', element('data', $view))); ?></textarea>
				</div>
			</div>
...
$(function() {
	$('#fadminwrite').validate({
		rules: {
			send_email_memberleave_admin_content : {'required_smarteditor' : true },
			send_email_memberleave_user_content : {'required_smarteditor' : true },
			send_note_memberleave_admin_content : {'required_smarteditor' : true }
		}
	});
});
