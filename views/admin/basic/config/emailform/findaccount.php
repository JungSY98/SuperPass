<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/findaccount'); ?>" onclick="return check_form_changed();">회원정보찾기</a></li>
		...
		?>
			...
			<div class="form-group row">
				<label class="col-sm-2 control-label">
					ID/PW 찾기<br>
					<button type="button" class="btn btn-xs btn-secondary reset_findaccount">내용초기화하기</button>
				</label>
				<div class="col-sm-10">
					...
					<div class="form-group col-sm-12">
						...
						<input type="text" class="form-control" name="send_email_findaccount_user_title_en" id="send_email_findaccount_user_title_en" value="<?php echo set_value('send_email_findaccount_user_title_en', element('send_email_findaccount_user_title_en', element('data', $view))); ?>" />
						</div>
					</div>
					<div class="form-group col-sm-12">
						<?php echo display_dhtml_editor('send_email_findaccount_user_content_en', set_value('send_email_findaccount_user_content_en', element('send_email_findaccount_user_content_en', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = "smarteditor"); ?>
					</div>
			...
			<div class="form-group row d-none">
				<label class="col-sm-2 control-label">
					인증메일재발송<br />
					<button type="button" class="btn btn-xs btn-secondary reset_resendverify">내용초기화하기</button>
				</label>
				<div class="col-sm-10">
					<div class="form-group col-sm-12">
...
$(function() {
	$('#fadminwrite').validate({
		rules: {
			...
			send_email_findaccount_user_content_en : {'required_smarteditor' : true },
