...
<div class="box">
	<div class="box-header pb-3">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item" role="presentation"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/metatag'); ?>" onclick="return check_form_changed();">메타태그</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/favicon'); ?>" onclick="return check_form_changed();">파비콘 등록</a></li>
		</ul>
	</div>
	<div class="box-table">
