<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item" role="presentation"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/membermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
