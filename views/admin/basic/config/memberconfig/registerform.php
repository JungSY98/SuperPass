<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">기본정보</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/registerform'); ?>" onclick="return check_form_changed();">가입폼관리</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/membermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/login'); ?>" onclick="return check_form_changed();">로그인</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/alarm'); ?>" onclick="return check_form_changed();">알림 설정</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/sociallogin'); ?>" onclick="return check_form_changed();">소셜로그인</a></li>
		</ul>
	</div>
	<div class="box-table">
					...
					<div class="form-group list-group-item2 row">
						...
						<div class="col-sm-3">
							<select name="field_type[<?php echo $key; ?>]" class="form-control field_type">
								...
								<option value="file" <?php echo element('field_type', $result) === 'file' ? ' selected="selected" ' : ''; ?>>첨부 파일(file)</option>
						...
						<div class="col-sm-1"><button type="button" class="btn btn-outline-danger btn-xs btn-delete-row" >삭제</button></div>
					</div>
				<?php
						}
					}
