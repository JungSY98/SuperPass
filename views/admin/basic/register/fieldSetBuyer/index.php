...
function fnDelAttr(no) {
	if (confirm("정말 삭제하시겠습니까?")) {
		$.ajax({
			method: "POST",
			url: "/admin/register/fieldSetBuyer/ajaxDeleteApplyFormElement/",
			dataType: "html",
			data: { 
				'no' : no,
...
function fnAddApplyForm() {
	...
	$.ajax({
		method: "POST",
		url: "/admin/register/fieldSetBuyer/ajaxGetApplyFormHTML/",
		dataType: "html",
		data: { 
			'type' : 'buyer',
...
function fnSetRequiredAct() {
	$(".btnRequired").on("click", function() {
		...
		isYN = isYN == true ? "Y" : "N";
		$.ajax({
			url: "/admin/register/fieldSetBuyer/ajaxSetRequiredStatus/",
			type: "POST",
			dataType: "html",
			data: {
...
function fnSetUseAct() {
	$(".btnUse").on("click", function() {
		...
		isYN = isYN == true ? "Y" : "N";
		$.ajax({
			url: "/admin/register/fieldSetBuyer/ajaxSetUseStatus/",
			type: "POST",
			dataType: "html",
			data: {
				'fNo' : $(this).attr("data-fno"),
...
function fnSetOrder(order) {
	$.ajax({
		method: "POST",
		url: "/admin/register/fieldSetBuyer/ajaxSetApplyFormOrder/",
		dataType: "html",
		data: { 
			'programNo' : 1,
			'pType' : 'buyer',
...
function fnManageApplyForm(no, type) {
	...
	$.ajax({
		method: "POST",
		url: "/admin/register/fieldSetBuyer/ajaxApplyForm/",
		dataType: "html",
		data: { 
			'pType' : type,
			'pNo' : no,
