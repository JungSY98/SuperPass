<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">본인인증설정</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/boards'); ?>" onclick="return check_form_changed();">게시판별사용여부</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
		...
		?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10 form-inline">
					<select name="use_selfcert_ipin" class="form-control" id="use_selfcert_ipin">
						...
						<option value="nice" <?php echo set_select('use_selfcert_ipin', 'nice', (element('use_selfcert_ipin', element('data', $view)) === 'nive' ? true : false)); ?> >NICE 아이핀</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10 form-inline">
					<select name="use_selfcert_phone" class="form-control" id="use_selfcert_phone">
						...
						<option value="nice" <?php echo set_select('use_selfcert_phone', 'nice', (element('use_selfcert_phone', element('data', $view)) === 'nice' ? true : false)); ?> >NICE 휴대폰 본인확인</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<label class="col-sm-2 control-label">NICE 사이트코드</label>
				<div class="col-sm-10 form-inline">
					<input type="text" class="form-control" name="selfcert_nice_mid" id="selfcert_nice_mid" value="<?php echo set_value('selfcert_nice_mid', element('selfcert_nice_mid', element('data', $view))); ?>" />
					<div class="help-block">NICE 에서 받은 SITE CODE 를 입력해주세요</div>
				</div>
			</div>
