...
<? foreach($bizD as $k => $bD) { ?>
			<tr>
				...
				<td class="text-center">
					<a href="/admin/archive/product/form/<?=$bD['no']?>" class="btn btn-sm btn-success">수정</a>
					<a href="/admin/archive/product/deleteData/<?=$bD['no']?>" class="btn btn-sm btn-danger" onclick="return confirm('정말 삭제하시겠습니까?\n\n한번 삭제한 자료를 복구 불가능합니다.')">삭제</a>
				</td>
			</tr>
<? } ?>
			</tbody>
