...
<?=form_open_multipart("/admin/archive/product/saveProduct/", array("METHOD"=>"POST"), array("viewNo"=>$viewNo, "year"=>$year))?>
	...
	<div class="row mb-2">
		...
		<div class="col-sm-10 pt-2">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input cateForm" type="radio" id="applyCategory1" name="applyCategory" value="brand" checked>
				<label class="form-check-label" for="applyCategory1">브랜드</label>
			</div>
