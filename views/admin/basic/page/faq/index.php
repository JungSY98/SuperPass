...
?>
			...
			<div class="table-responsive">
				<table class="table ">
					...
					?>
						<tr>
							<td class="d-none"><?=element('faq_cate', $result)?></td>
							...
							<td><a href="<?php echo admin_url($this->pagedir); ?>/write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>&fgr_id=<?=element('fgr_id', $result)?>" class="btn btn-secondary  btn-xs">수정</a></td>
