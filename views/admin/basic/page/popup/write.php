		...
		?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<input type="number" class="form-control" name="pop_left" value="<?php echo set_value('pop_left', element('pop_left', element('data', $view))); ?>" />
					<span class="input-group-text">px - 좌측정렬시만 해당</span>
					</div>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="input-group">
					<input type="number" class="form-control" name="pop_top" value="<?php echo set_value('pop_top', element('pop_top', element('data', $view))); ?>" />
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<span class="input-group-text">Width</span>
					 <input type="number" class="form-control" name="pop_width" value="<?php echo set_value('pop_width', element('pop_width', element('data', $view))); ?>" />
					 <span class="input-group-text">px</span>
					 <span class="input-group-text">Height</span>
					<input type="number" class="form-control" name="pop_height" value="<?php echo set_value('pop_height', element('pop_height', element('data', $view))); ?>" />
					<span class="input-group-text">px</span>
					</div>
				</div>
			</div>
