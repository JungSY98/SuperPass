...
?>
				<div class="btn-group float-end" role="group" aria-label="...">
					<button type="button" class="btn btn-outline btn-dark btn-sm btn-list-update btn-list-selected disabled" data-list-update-url = "<?php echo element('list_update_url', $view); ?>" >선택수정</button>
...
?>
						<tr class="success">
							<td>
								<div class="input-group form-group-sm">
									...
									<input type="text" name="men_name_en[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_name_en', $result)); ?>" />
								</div>
							</td>
							<td>
						...
						<tr class="success">
							<th class="text-right"><div class="text-right float-end">링크주소</div></th>
							<td colspan="6">
								<div class="form-group form-group-sm">
...
?>
						<tr class="warning">
							<td class="text-right">
								<div class="input-group form-group-sm form-inline d-flex">
									...
									<input type="text" name="men_name_en[<?php echo element(element('primary_key', $view), $subresult); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_name_en', $subresult)); ?>" />
								</div>
							</td>
							<td>
								<div class="form-group form-group-sm">
						...
						<tr class="warning">
							<th class="text-right"><div class="pull-right">링크주소</div></th>
							<td colspan="6">
								<div class="form-group form-group-sm">
...
<?=$buttons?>
	...
	<div class="box mt-5">
		...
		?>
						...
						<tr>
							<td>
								<div class="input-group form-group-sm">
									...
									<input type="text" name="men_name_en" class="form-control input-sm" value="" />
								</div>
							</td>
							<td>
								<div class="form-group form-group-sm">
			...
			<div class="btn-group col-sm-12 w-100 mb-10" role="group" aria-label="...">
