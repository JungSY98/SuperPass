	...
	<div class="box-header">
		...
		?>
			...
			<div class="form-group row">
				<label class="col-sm-2 control-label">제목 (국문)</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="fgr_title" value="<?php echo set_value('fgr_title', element('fgr_title', element('data', $view))); ?>" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 control-label">제목 (영문)</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="fgr_title_en" value="<?php echo set_value('fgr_title_en', element('fgr_title_en', element('data', $view))); ?>" />
				</div>
			</div>
			<div class="form-group row">
