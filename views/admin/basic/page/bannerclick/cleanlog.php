	...
	<div class="box-header">
		<div class="box-table-header">
			<ul class="nav nav-pills">
				...
				<li role="presentation" class="nav-item"><a href="<?php echo admin_url($this->pagedir . '/cleanlog'); ?>" class="nav-link active ">오래된 로그삭제</a></li>
			</ul>
					...
					<tr>
						<td>
							...
							?>
								...
								<input type="number" class="form-control" name="day" value="<?php echo set_value('day', 180); ?>" />
								<div class="input-group-text">일 이상된 배너클릭 로그를 모두 검색합니다.</div>
