	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-pills">
				...
				<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/graph'); ?>">로그인 성공 그래프</a></li>
				<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/graph_fail'); ?>">로그인 실패 그래프</a></li>
