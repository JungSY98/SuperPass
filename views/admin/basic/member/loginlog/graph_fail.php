	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-pills">
				<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">목록</a></li>
				<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/graph'); ?>">로그인 성공 그래프</a></li>
				<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/graph_fail'); ?>">로그인 실패 그래프</a></li>
		...
		<div class="table-responsive">
			<div class="pull-right form-group">
				<label for="withoutzero" class="checkbox-inline">
					<input type="checkbox" name="withoutzero" id="withoutzero" value="1" /> 회수가 0 인 데이터 제외
				</label>
...
$(document).on('click', '#export_to_excel', function(){
	exporturl = '<?php echo admin_url($this->pagedir . '/graph_fail/excel' . '?' . $this->input->server('QUERY_STRING', null, '')); ?>';
