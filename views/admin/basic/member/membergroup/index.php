<div class="box">
	<div class="box-header">
		...
		?>
			...
			<div class="row m-5"><?php echo element('total_rows', element('data', $view), 0); ?>개의 그룹이 존재합니다</div>
			<div class="list-group">
				...
				<div id="sortable">
					...
					?>
						<div class="form-group row list-group-item2">
