		...
		?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					?>
						<label for="member_group_<?php echo element('mgr_id', $gval); ?>" class="checkbox-inline float-start m-3">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="input-group">
						...
						<label class="col-4 pb-2"><input type="radio" name="mem_sex" value="1" <?php echo set_radio('mem_sex', '1', (element('mem_sex', element('data', $view)) === '1' ? true : false)); ?>> Male</label>
						<label class="col-4 pb-2"><input type="radio" name="mem_sex" value="2" <?php echo set_radio('mem_sex', '2', (element('mem_sex', element('data', $view)) === '2' ? true : false)); ?>> Female</label>
						<label class="col-4 pb-2"><input type="radio" name="mem_sex" value="3" <?php echo set_radio('mem_sex', '3', (element('mem_sex', element('data', $view)) === '3' ? true : false)); ?>> Transgender</label>
						<label class="col-4 pb-2"><input type="radio" name="mem_sex" value="4" <?php echo set_radio('mem_sex', '4', (element('mem_sex', element('data', $view)) === '4' ? true : false)); ?>> Nonbinary</label>
						<label class="col-4 pb-2"><input type="radio" name="mem_sex" value="5" <?php echo set_radio('mem_sex', '5', (element('mem_sex', element('data', $view)) === '5' ? true : false)); ?>> Agender</label>
...
$(function() {
	$('#fadminwrite').validate({
		rules: {
			mem_userid: { required: true, minlength:3, maxlength:100 },
