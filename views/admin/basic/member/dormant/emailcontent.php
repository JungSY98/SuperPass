<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/cleantodormant'); ?>" onclick="return check_form_changed();">휴면계정일괄정리</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/emailtowaiting'); ?>" onclick="return check_form_changed();">안내메일일괄발송</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/emailcontent'); ?>" onclick="return check_form_changed();">안내메일내용</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/emailsendlist'); ?>" onclick="return check_form_changed();">안내메일발송내역</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/waitinglist'); ?>" onclick="return check_form_changed();">휴면처리해야할회원</a></li>
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/dormantlist'); ?>" onclick="return check_form_changed();">휴면중인회원</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
