	...
	?>
		<div class="box-header">
			...
			<ul class="nav nav-tabs clearfix">
				<li class="nav-item active" role="presentation"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write/' . element('bgr_id', element('data', $view))); ?>" onclick="return check_form_changed();">기본정보</a></li>
				<li  class="nav-item"role="presentation"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write_admin/' . element('bgr_id', element('data', $view))); ?>" onclick="return check_form_changed();">그룹관리자</a></li>
			</ul>
		</div>
	<?php
	} else {
	?>
		<div class="box-header">
			<ul class="nav nav-tabs">
				<li class="nav-item" role="presentation" ><a class="nav-link active" href="javascript:;">기본정보</a></li>
				<li class="nav-item" role="presentation"><a class="nav-link" href="javascript:;" onClick="alert('기본정보를 저장하신 후에 다른 정보 수정이 가능합니다');">그룹관리자</a></li>
			</ul>
		</div>
	<?php
	}
