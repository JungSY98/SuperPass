<div class="box">
	...
	?>
		<div class="box-header">
			...
			<ul class="nav nav-tabs clearfix">
				<li class="nav-item" role="presentation" ><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write/' . element('bgr_id', element('data', $view))); ?>">기본정보</a></li>
				<li class="nav-item" role="presentation"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_admin/' . element('bgr_id', element('data', $view))); ?>">그룹관리자</a></li>
			</ul>
		</div>
	...
	<div class="box-table clearfix">
		...
		?>
			<div class="box-table-header clearfix">
