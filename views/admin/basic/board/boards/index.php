			...
			<div class="box-table-header clearfix clearfix">
				...
				?>
					<div class="btn-group float-end" role="group" aria-label="...">
						<a href="<?php echo element('listall_url', $view); ?>" class="btn btn-outline btn-dark btn-sm">전체목록</a>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><a href="<?php echo admin_url($this->pagedir); ?>/write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>" class="btn btn-outline btn-dark btn-xs">수정</a></td>
			...
			<div class="row m-5">
				<div class="col-md-6 offset-md-3">
					<div class="input-group">
						...
						<button class="btn btn-dark" name="search_submit" type="submit">검색!</button>
					</div>
				</div>
			</div>
		</div>
