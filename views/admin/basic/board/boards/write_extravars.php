<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs">
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">기본정보</a></li>
			...
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_extravars/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">사용자정의</a></li>
	...
	<div class="box-table clearfix">
		...
		?>
			...
			<div class="list-group">
				<div class="form-group list-group-item2 row">
				...
				<div id="sortable">
					...
					?>
						<div class="form-group list-group-item">
							...
							<div class="col-sm-2"><button type="button" class="btn btn-outline btn-dark btn-xs btn-delete-row" >삭제</button></div>
						</div>
					<?php
						}
					}
