<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_category/' . element('brd_id', element('data', $view))); ?>">카테고리</a></li>
			...
			<li role="presentation" class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write_admin/' . element('brd_id', element('data', $view))); ?>">게시판관리자</a></li>
		</ul>
	</div>
					...
					foreach ($p as $result) {
						...
						$return .= '
															...
															<div class="form-group" style="margin-left:0;">
																...
																<a href="javascript:;" class="btn btn-dark btn-xs" onClick="cat_cancel(\'' . element('bca_id', $result) . '\')">취소</a>
															</div>';
						$return .= form_close();
						$return .= '				</div>
													</div>
